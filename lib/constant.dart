...
/// It includes app configuration, UI styling, phonics data, and utility functions.
/// 
...
/// 
/// This includes:
/// - Single letter sounds (a-z)
/// - Vowel combinations (ai, ay, oa, etc.)
/// - Consonant blends (ch, sh, th, etc.)
/// - Special sounds (er, ir, or, ur, etc.)
/// - Silent letter patterns (_a_e, _e_e, etc.)
...
/// 
/// Creates a subtle drop shadow with:
/// - Grey color
/// - 2px spread radius
/// - 4px blur radius
/// - 2px offset in both x and y directions
